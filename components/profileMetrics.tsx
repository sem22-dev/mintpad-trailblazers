  ...
  return (
    <div className="py-16 px-12 xl:px-40 relative">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 xl:grid-cols-5 gap-4">
        {/* Rank 1 */}
        <div
          className="relative col-span-2 row-span-2 gap-4 text-white text-xl"
        >
          <div className="absolute inset-0 rounded-[24px] bg-gradient-border p-[1px] z-0">
            <div className="h-full w-full rounded-[24px]" style={{ backgroundImage: 'linear-gradient(to bottom, #170E22 0%, #0E133C 100%)' }}></div>
          </div>
          <div className="relative z-10 flex flex-col gap-4 h-full items-center justify-center">
       ...
       >
         <div className="absolute inset-0 rounded-[24px] bg-gradient-border p-[1px] z-0">
           <div className="h-full w-full rounded-[24px] bg-[#151515]"></div>
         </div>
         <div className="relative z-10 flex h-full py-8 flex-col justify-center items-center gap-2">
